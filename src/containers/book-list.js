...
import { connect } from 'react-redux'; // {} simple property
...
// takes state as argument and the value returned is this.props inside of BookList
// usually returns an object
// whenever state changes this function will re-render
